...
import {View,StyleSheet,Text,ActivityIndicator,FlatList,Dimensions,Image,TouchableWithoutFeedback,Linking,Share} from 'react-native';
...
export default class App extends React.Component{
  ...
  fetchnews = () => {
    fetch('http://newsapi.org/v2/everything?q=bitcoin&from=2020-08-24&sortBy=publishedAt&apiKey=1f1b9a65614445808e3237fa29cc0c00')
    .then((res)=>res.json())
    .then((response)=>{
      this.setState({
